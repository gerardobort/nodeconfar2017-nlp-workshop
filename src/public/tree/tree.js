function loadSentenceTree(text) {
  ...
  // Load data
  d3.json('/api/sentence' + document.location.search, function (data) {
    console.log(data);

    const treeData = data.sentence.parseTree.rootNode;
    governors = data.sentence.enhancedPlusPlusDependencies;
